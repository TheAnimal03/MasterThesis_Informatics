...
class MobilenetV2(nn.Module):
    def __init__(
        ...
        if weight_path and not resume:
            ...
            self.__submodule.load_state_dict(model_dict, strict=False)
            del pretrained_dict
...
#     def __init__(
#         self,
#         weight_path=None, #'https://www.dropbox.com/s/47tyzpofuuyyv1b/mobilenetv2_1.0-f2a8633.pth.tar?dl=1',
#         resume=False,
#         extract_list=["6", "13", "conv"],
#         feature_channels=[32, 96, 1280],
#         width_mult=1.0,
...
#             self.model = self.mobilenet_v2(weight_pa=weight_path)
#            # self.__submodule.model
#             #del pretrained_dict

#             print("Loaded weight of MobilenetV2 : {}".format(weight_path))

#         self.__extractor = FeatureExtractor(self.model, extract_list)

#     def forward(self, x):
#         return self.__extractor(x)
      
#     def mobilenet_v2(pretrained=True, weight_pa=None):#, submodule=None):
