...
Cfg.train_label = r'/content/gdrive/MyDrive/Uni/MA/coco/train2017.txt' #os.path.join(_BASE_DIR, 'coco', 'train2017_.txt') #r'G:\My Drive\Uni\MA\coco\train2017_.txt' #os.path.join(_BASE_DIR, 'data', 'train.txt')
Cfg.val_label = r'/content/gdrive/MyDrive/Uni/MA/coco/val2017.txt' #os.path.join(_BASE_DIR, 'data' ,'val.txt') #os.path.join(_BASE_DIR, 'coco','val2017_.txt') #r'G:\My Drive\Uni\MA\coco\val2017_.txt' #os.path.join(_BASE_DIR, 'data' ,'val.txt')
